...
public class Clock extends View {
    ...
    private String[] Number= {"3","2","1","12","11","10","9","8","7","6","5","4"};
    ...
    private  void drawNumber(Canvas canvas)
    {
        ...
        for (int i = 0; i < FULL_ANGLE; i += 30 /* Step */) {
            ...
            String num = Number[i/30];

            int stopX = (int) (mCenterX + 0.8*rEnd * Math.cos(Math.toRadians(i)));
            int stopY = (int) (mCenterX - 0.8*rEnd * Math.sin(Math.toRadians(i)));

            canvas.drawText(num, stopX, stopY, mpaint);
