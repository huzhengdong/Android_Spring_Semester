...
public class UploadActivity extends AppCompatActivity {
    ...
    private void submit() {
        ...
        File file = new File(coverImageUri.toString());
        ...
        MultipartBody.Part image_part = MultipartBody.Part.createFormData("image", "abc.jpg", requestFile);
        new Thread(new Runnable() {
            @Override
            public void run() {
                Call < UploadResponse > call = api.submitMessage(Constants.STUDENT_ID, "", from_part, to_part, content_part, image_part, Constants.token);
                try {
