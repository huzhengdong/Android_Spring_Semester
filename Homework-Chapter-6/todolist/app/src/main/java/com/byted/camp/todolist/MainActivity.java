...
//                        .setAction("Action", null).show();
        ...
        notesAdapter.setLongClickListener(new NoteListAdapter.OnLongClickListener(){
            public boolean onLongClick(int position) {
                ...
                edit.putExtra("data", position);
                edit.putExtra("id", notesAdapter.getItemID(position));
                edit.putExtra("note", notesAdapter.getItemNote(position));
                edit.putExtra("priority", notesAdapter.getItemPriority(position));
                startActivityForResult(edit, REQUEST_CODE_ADD);
                return false;
            }
        } );
